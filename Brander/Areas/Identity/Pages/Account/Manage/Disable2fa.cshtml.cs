...
namespace Brander.Areas.Identity.Pages.Account.Manage
{
    public class Disable2faModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            {
                throw new InvalidOperationException($"No se puede deshabilitar 2FA para usuarios con ID '{_userManager.GetUserId(User)}' ya que no está habilitado actualmente.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Usuario con ID'{UserId}' ha deshabilitado 2fa.", _userManager.GetUserId(User));
